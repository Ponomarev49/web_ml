...
def page_data_visualization():
    ...
    selected_column_hist = st.selectbox('Выберите колонку', data.columns, key="select_hist")
    ...
    # Отображение выбора колонки и гистограммы
    selected_column_box = st.selectbox('Выберите колонку', data.columns, key="select_box")
...
#         input_data = {}
#
#         input_data['distance_from_home'] = st.number_input("distance_from_home", min_value=0.0, max_value=100000.0,
#                                                            value=0.577820)
#         input_data['distance_from_last_transaction'] = st.number_input("distance_from_last_transaction",
#                                                                        min_value=-10000.0, max_value=10000.0,
#                                                                        value=-0.139317)
#         input_data['ratio_to_median_purchase_price'] = st.number_input("ratio_to_median_purchase_price", min_value=0.0,
#                                                                        max_value=100000.0, value=2.34122)
#         input_data['repeat_retailer'] = st.number_input("repeat_retailer", min_value=0.0, max_value=1.0, step=1.0,
#                                                         value=1.0)
#         input_data['used_chip'] = st.number_input("used_chip", min_value=0.0, max_value=1.0, step=1.0, value=1.0)
#         input_data['used_pin_number'] = st.number_input("used_pin_number", min_value=0.0, max_value=1.0, step=1.0,
#                                                         value=0.0)
